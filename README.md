...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); grid-column-gap: 9px; grid-row-gap: 0px; background-color: pink; padding: 10px;">
    <picture>
        ...
        />
        <source
            srcset="https://github-readme-stats.vercel.app/api?username=SDVGB&show_icons=true&bg_color=00000000&locale=es&hide_title=true&ring_color=ee6fec&rank_icon=github&icon_color=ee6fec&text_color=000000&card_width=480px"
